...
<div class="section_container">
    <div class="section1">
        ...
        <div class="legend">
            <div class="legend-item">
                <div class="legend-color bg-red" style="background-color: red;"></div>
                <div class="legenditem"><b>Attendance</b></div>
            </div>
            <div class="legend-item">
                <div class="legend-color bg-blue" style="background-color: blue;"></div>
                <div class="legenditem"><b>Attendance</b></div>
            </div>
            <div class="legend-item">
                <div class="legend-color bg-yellow" style="background-color: #F3E3AA;"></div>
                <div class="legenditem"><b>Attendance</b></div>
            </div>
        </div>
    </div>
    <div class="section2">
        ...
        <div class="row check">
        <button class="check_in "><b>Check In</b></button>
         <button class="check_out d-none"><b>Check Out</b></button>
         <button class="resume d-none"><b>Resume</b></button>
         <button class="break d-none"><b>Break</b></button>
        </div>
     
    </div>
    <div class="section3">
        <button class="buttons project_report"><b>Projects Report</b></button>
        <button class="buttons attendance"><b>Attendance Report</b></button>
        <button class="buttons leaves"><b>Leaves</b></button>
        <button class="buttons policies"><b>Policies</b></button>
        <button class="buttons repository"><b>Repository</b></button>
    </div>
</div>
